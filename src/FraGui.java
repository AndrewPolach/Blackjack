...
public class FraGui extends JFrame {
    ...
    public static void main(String[] args) {
        ...
        myFrame.setPreferredSize(new Dimension(700, 400));
        myFrame.pack();
        ...
        //myFrame.add(myFrame, BorderLayout.CENTER);
        ...
        myFrame.setVisible(true);
         ...
         //panColour = new JPanel();
        //panColour.add(new Background("Background.png"));
        // myFame.add(panColour);
    ...
    public void init() {
        ...
        add(panEast, BorderLayout.NORTH);
        ...
        // add(panColour, BorderLayout.CENTER)
        for (int i = 0; i < 6; i++) {
